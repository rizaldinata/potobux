...
<head>
    ...
    <style>
        ...
        .hero-glow {
            background: radial-gradient(ellipse 80% 60% at 50% 20%, rgba(123, 31, 58, 0.35) 0%, transparent 70%);
        }
...
<body class="min-h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <div class="w-full max-w-md px-6 relative z-10">
        ...
        <div class="auth-card rounded-2xl p-8">
            ...
            <p class="text-gray-500 text-sm mb-7">Masuk untuk mengakses Studio Potobux</p>
            ...
            <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-5">
                ...
                <div>
                    ...
                    <input type="password" name="password" required
                        class="auth-input w-full rounded-xl px-4 py-3 text-sm" placeholder="••••••••">
                </div>
                <button type="submit" class="btn-primary w-full py-3.5 rounded-xl font-bold text-sm mt-1">
                    Masuk ke Studio →
                </button>
            </form>
            ...
            <div class="mt-6 pt-6 flex flex-col gap-2 text-center text-sm"
                ...
                <p class="text-gray-600">
                    Belum punya akun?
                    <a href="{{ route('register') }}" style="color:#D4758D;" class="font-bold hover:underline">Daftar
                        Gratis</a>
                </p>
